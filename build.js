...
async function runServer() {
  await doCommand(`./node_modules/.bin/babel src --copy-files --source-maps --extensions .es6,.es,.jsx --out-dir lib`);
}
/**
 *
...
function successLog() {
  ...
  console.log(chalk.yellow('---------------------------------------'))
  console.log(chalk.yellow('---------------------------------------\n'))
  console.log(chalk.blue(`即将执行命令：./node_modules/.bin/babel src --copy-files --source-maps --extensions .es6,.es,.jsx --out-dir lib\n`))
}